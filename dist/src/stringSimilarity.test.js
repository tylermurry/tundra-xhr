...
describe('stringSimilarity', function () {
  ...
  it('should match a target that has asterisks against a wildcarded source', function () {
    expect((0, _stringSimilarity2.default)('before' + WILDCARD + 'after*', 'beforeabceafter*')).toBe(true);
  });
